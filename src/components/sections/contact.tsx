                ...
                <div className='flex items-center flex-wrap lg:flex-nowrap bg-[#F4F6FB] dark:bg-[#001E45]  rounded-3xl overflow-hidden '>
                    ...
                    <h3 className="text-4xl font-semibold leading-[38.73px] text-center mb-[32px]">{ t('contact_us')}</h3>
                        ...
                        <div className="flex gap-4 mb-4">
                            <input  {...register('phone', { required: 'Phone is required' })} type="text" className="w-full dark:bg-[#001E45] dark:border dark:border-[#00132D] px-[16px] py-[14px] rounded-xl text-sm font-normal leading-6 text-left" placeholder={ t('phone_number')}/> 
                            <input  {...register('email', { required: 'Email is required' })} type="email" className="w-full dark:bg-[#001E45] dark:border dark:border-[#00132D] px-[16px] py-[14px] rounded-xl text-sm font-normal leading-6 text-left" placeholder={ t('email')}/> 
                        </div>
                        <input  {...register('subject', { required: 'Subject is required' })} type="text" className="w-full dark:bg-[#001E45] dark:border dark:border-[#00132D] px-[16px] py-[14px] rounded-xl text-sm font-normal leading-6 text-left mb-4" placeholder={ t('subject')}/> 
                        <input  {...register('message', { required: 'Message is required' })} type="text" className="w-full dark:bg-[#001E45] dark:border dark:border-[#00132D] px-[16px] py-[14px] rounded-xl text-sm font-normal leading-6 text-left mb-12" placeholder={ t('message')}/>
