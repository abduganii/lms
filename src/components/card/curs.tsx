...
export default function CursCard({image,title,date,className}:any) {
    return (
    <div className={`w-full p-3 rounded-xl bg-white ${className && className}`} >
        <Image className="w-full object-contain rounded-xl aspect-w-[1.37] aspect-h-[1] " alt="img"  src={img1} width={246} height={180}/>

        <h3 className="text-base font-semibold leading-6 text-left mt-3 mb-10">
            {title}
        </h3>
